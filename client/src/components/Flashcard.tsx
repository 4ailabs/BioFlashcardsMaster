...
const Flashcard = ({ card }: FlashcardProps) => {
  ...
  return (
    <div className="flashcard w-full max-w-2xl mx-auto h-[60vh] sm:h-[500px] mb-4 sm:mb-8">
      ...
      >
        {/* Front of card */}
        <div className="card-front absolute w-full h-full rounded-2xl shadow-lg bg-gradient-to-br from-white to-slate-50 dark:from-slate-800 dark:to-slate-900 border border-slate-200 dark:border-slate-700 p-3 sm:p-6 flex flex-col">
          ...
          <div className="flex-1 flex items-center justify-center relative z-10">
            <div className="text-center relative w-full">
              <div className="relative">
                ...
                <div className={`h-1.5 w-16 sm:w-20 ${categoryColorClass} rounded-full mx-auto mb-4 sm:mb-6`}></div>
          ...
          <div className="mt-3 sm:mt-4 text-center">
            <div className="bg-slate-100 dark:bg-slate-700 rounded-full px-3 sm:px-4 py-1 sm:py-1.5 shadow-inner inline-block">
              <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300">Clic para ver detalles</p>
        ...
        {/* Back of card */}
        <div className="card-back absolute w-full h-full rounded-2xl shadow-lg bg-gradient-to-br from-white to-slate-50 dark:from-slate-800 dark:to-slate-900 border border-slate-200 dark:border-slate-700 p-3 sm:p-6 flex flex-col">
          ...
          <div className="mt-1 sm:mt-2 relative z-10">
            <div className="flex items-center mb-2 sm:mb-3">
              <div className={`h-2 sm:h-3 w-2 sm:w-3 rounded-full ${categoryColorClass} mr-2`}></div>
